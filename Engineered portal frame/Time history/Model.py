...
ops.mass(2, 8.66,8.66,0)
ops.mass(3, 8.66,8.66,0)
ops.mass(4, 4.85, 4.85, 0)
ops.mass(6, 12.22, 12.22, 0)
ops.mass(7, 12.22, 12.22, 0)
ops.mass(8, 8.14, 8.14, 0)
ops.mass(10, 6.71, 6.71,0)
ops.mass(11, 6.71, 6.71,0)
ops.mass(12, 3.56, 3.56,0)
...
b_col = 0.300  # column base
h_col = 0.300  # column height
...
PDTransCol = 1
LTransBeam = 2
ops.geomTransf("Linear", PDTransCol) 
ops.geomTransf("Linear", LTransBeam)
         
NI = 5

ops.element("nonlinearBeamColumn", 1, 1, 2, NI, Col300x300_8_16, PDTransCol)
ops.element("nonlinearBeamColumn", 2, 2, 3, NI, Col300x300_4_16_4_12, PDTransCol)
ops.element("nonlinearBeamColumn", 3, 3, 4, NI, Col300x300_8_12, PDTransCol)
ops.element("nonlinearBeamColumn", 4, 5, 6, NI, Col300x300_8_16, PDTransCol)
ops.element("nonlinearBeamColumn", 5, 6, 7, NI, Col300x300_4_16_4_12, PDTransCol)
ops.element("nonlinearBeamColumn", 6, 7, 8, NI, Col300x300_8_12, PDTransCol)
ops.element("nonlinearBeamColumn", 7, 9, 10, NI, Col300x300_8_16, PDTransCol)
ops.element("nonlinearBeamColumn", 8, 10, 11, NI, Col300x300_4_16_4_12, PDTransCol)
ops.element("nonlinearBeamColumn", 9, 11, 12, NI, Col300x300_8_12, PDTransCol)
