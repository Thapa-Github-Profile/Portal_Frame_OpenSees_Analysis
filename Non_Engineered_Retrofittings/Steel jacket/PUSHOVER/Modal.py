...
FiberBuilder.AngleBuilder(Gcol, h_col, b_col, r_col, C_conf, C_unconf, R_steel, Rebar_16, 0.00000000001 ,Angle_Material,0.05,0.005)
FiberBuilder.AngleBuilder(Fcol, h_col, b_col, r_col, C_conf, C_unconf, R_steel, Rebar_12, 0.00000000001 ,Angle_Material,0.05,0.005)
FiberBuilder.AngleBuilder(Scol, h_col, b_col, r_col, C_conf, C_unconf, R_steel, Rebar_12, 0.00000000001 ,Angle_Material,0.05,0.005)
...
ops.geomTransf('Linear', LTransBeaY)
