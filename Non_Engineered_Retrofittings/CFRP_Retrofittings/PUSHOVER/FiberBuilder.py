...
def JacketBuilder(id, HSec, BSec, cover, coreID, coverID, steelID, barAreaCorner, barAreaInt,jack_unconfinedID,Jacket_confinedID,JbarAreaInt,JbarAreaCorner,thickness,jacket_Cover):
    ...
    ops.patch( 'quadr', jack_unconfinedID, 4, 8, -coverYplusjacket, coverZplusjacket, -(coverYplusjacket-thickness), (coverZplusjacket-thickness), (coverYplusjacket-thickness), (coverZplusjacket-thickness), coverYplusjacket, coverZplusjacket)
    ops.patch( 'quadr', jack_unconfinedID, 4, 8, -(coverYplusjacket-thickness), -(coverZplusjacket-thickness), -coverYplusjacket, -coverZplusjacket, coverYplusjacket, -coverZplusjacket, (coverYplusjacket-thickness), -(coverZplusjacket-thickness))
    ops.patch( 'quadr', jack_unconfinedID, 8, 4, -coverYplusjacket, coverZplusjacket, -coverYplusjacket, -coverZplusjacket, -(coverYplusjacket-thickness), -(coverZplusjacket-thickness), -(coverYplusjacket-thickness), (coverZplusjacket-thickness))
    ops.patch( 'quadr', jack_unconfinedID, 8, 4, (coverYplusjacket-thickness), (coverZplusjacket-thickness), (coverYplusjacket-thickness), -(coverZplusjacket-thickness), coverYplusjacket, -coverZplusjacket, coverYplusjacket, coverZplusjacket)
    
    ops.patch( 'quadr', Jacket_confinedID, 4, 8, -coverYplusjacket, coverZplusjacket, -coreY, coreZ, coreY, coreZ, coverYplusjacket, coverZplusjacket)
    ops.patch( 'quadr', Jacket_confinedID, 4, 8, -coreY, -coreZ, -coverYplusjacket, -coverZplusjacket, coverYplusjacket, -coverZplusjacket, coreY, -coreZ)
    ops.patch( 'quadr', Jacket_confinedID, 8, 4, -coverYplusjacket, coverZplusjacket, -coverYplusjacket, -coverZplusjacket, -coreY, -coreZ, -coreY, coreZ)
    ops.patch( 'quadr', Jacket_confinedID, 8, 4, coreY, coreZ, coreY, -coreZ, coverYplusjacket, -coverZplusjacket, coverYplusjacket, coverZplusjacket)
...
def BeamBuilderCFRP(id, HSec, BSec, cover, coreID, coverID, steelID, numBarsTop, barAreaTop, numBarsBot, barAreaBot,fiberid,ft):
    coverY = HSec / 2.0
    coverZ = BSec / 2.0
    coreY = coverY - cover
    coreZ = coverZ - cover
    ...
    ops.layer('straight', steelID, numBarsBot, barAreaBot, -coreY, coreZ, -coreY, -coreZ)  # bottom layer reinforcement
    # Defining CFRP layer
    ops.patch('quadr', fiberid, 2, 6, -(coverY), (coverZ), -(coverY+ft), coverZ, -(coverY+ft), -coverZ, -(coverY), -(coverZ))
